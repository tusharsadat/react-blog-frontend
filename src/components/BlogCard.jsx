      ...
      <div className="card border-0 shadow-lg">
        ...
        <div className="card-body">
          ...
          <p className="card-text" style={{ textAlign: "justify" }}>
            ...
            soluta ex voluptatum eligendi saepe, reprehenderit veniam, ducimus
            odio iure recusandae explicabo sapiente necessitatibus est
            voluptates impedit et harum similique.
          </p>
